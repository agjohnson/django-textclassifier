...
class TestClassifier(TestCase):
    ...
    def test_classifier_classifies(self):
        classifier = NaiveBayesClassifier(field_name='foobar')
    ...
    def test_classifier_missing_training_data(self):
        classifier = NaiveBayesClassifier(field_name='not_foobar')
    ...
    def test_classifier_uses_incomplete_training_data(self):
        ...
        classifier = NaiveBayesClassifier(field_name='more_foobar')
